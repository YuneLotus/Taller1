...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais al que representa el atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	//Nueva opcion, a que pais representa el atleta
	
	private void ejecutarPaisRepresenta()
	{
		System.out.println("\n" + "A que pais representa el atleta" + "\n");
		String atletanombre = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.Atletapais(atletanombre);
		if (!pais.equals("null"))
		{
			System.out.println("\n" + atletanombre + " representa a " + pais + "\n");
		}
		else
		{
			System.out.println("\n" + "ERROR" + "\n");
